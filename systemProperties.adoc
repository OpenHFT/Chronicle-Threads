...
| chronicle.disk.monitor.disable | `false` | Disable the background disk space monitor (see decision link:src/main/adoc/decision-log.adoc#THR-OPS-003[THR-OPS-003]) | _DISABLED_ (boolean)
| chronicle.disk.monitor.threshold.percent | 5% | Issue warnings when free space drops below this percentage (see decision link:src/main/adoc/decision-log.adoc#THR-OPS-003[THR-OPS-003]) | _thresholdPercentage_ (int)
