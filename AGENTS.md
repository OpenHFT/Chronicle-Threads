...
* how to write documentation and Javadoc in **British English** with **7-bit ASCII** only;
* what *not* to comment;
...
- _Smoother Onboarding_: Up-to-date AsciiDoc clarifies the system for new developers or team members switching contexts.
