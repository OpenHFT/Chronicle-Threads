...
* link:architecture-overview.adoc[architecture-overview.adoc] – for loop topology and handler placement.
* link:thread-performance-targets.adoc[thread-performance-targets.adoc] – for performance expectations that influence safe handler design.
* link:operational-controls.adoc[operational-controls.adoc] – for operational safeguards that rely on thread-safety guarantees.
