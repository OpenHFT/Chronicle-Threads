...
Chronicle Threads is a _Foundation (Zone C)_ module in the Chronicle stack, as defined in `Chronicle-Quality-Rules/src/main/docs/architectural-standards.adoc`.
