...
. *Execution Contract*
*THR-FN-006* An `EventHandler`'s `action()` method MUST be invoked serially on the `EventLoop`'s dedicated thread. (See decision link:decision-log.adoc#THR-FN-001[THR-FN-001].)
